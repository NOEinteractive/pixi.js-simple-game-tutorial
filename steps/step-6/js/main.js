...
(function() {
    ...
    //our main ship
	var ship, bkg1, bkg2, enemiesManager, bulletsManager, collisionManager = null;
    
    // load all needed assets
    var loader = new PIXI.AssetLoader(['img/bkg-1.jpg', 'img/bkg-2.jpg', 'img/enemy.json', 'img/starfield-1.png', 'img/ship.json', 'img/bullet.png']);
	...
	function animate() {
	    ...
	    // render the stage and check collisions
